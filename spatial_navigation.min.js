...
Element.prototype.webkitMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||function(a){return 0<=[].slice.call((this.parentNode||this.document).querySelectorAll(a)).indexOf(this)},n={init:function(a){var b=[];K||(window.addEventListener("keydown",R),window.addEventListener("keyup",S),window.addEventListener("focus",T,!0),window.addEventListener("blur",U,!0),K=!0,a&&(b=a.map(function(a){return n.add(a)}),n.makeFocusable(),n.focus()));return b},uninit:function(){window.removeEventListener("blur",
...
window.SpatialNavigation=n;"object"===typeof module&&(module.exports=n)})();